...
Follow the coding standards in `./00_CORE_RULES/01_CODING_RULES.md`.
...
- All public APIs need DocC comments (see `./00_CORE_RULES/03_DOCC_GUIDELINES.md`)

## Testing (TDD)

Follow `./00_CORE_RULES/09_TEST_DRIVEN_DEVELOPMENT.md`:
